<template>
  <div class="home-view">
    ...
    <div class="game-container">
      ...
      <div class="click-limit-container">
        <p class="click-limit">⚡️ {{ store.clickLimit - store.clickCount }} / {{ store.clickLimit }}</p>
        <button @click="openUpgradeTab" class="boost-button">🚀boost</button>
      </div>
    </div>
  </div>
</template>
